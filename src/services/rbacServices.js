...
export const updateRole = async (roleId, updates, updatedBy) => {
	return runTransaction(async (session) => {
...
export const deleteRole = async (roleId, deletedBy) => {
	return runTransaction(async (session) => {
...
export const createPermission = async (permissionData, createdBy) => {
	return runTransaction(async (session) => {
...
export const assignPermissionsToRole = async (roleId, permissionIds, updatedBy) => {
	return runTransaction(async (session) => {
...
export const removePermissionFromRole = async (roleId, permissionId, updatedBy) => {
	return runTransaction(async (session) => {
		const role = await Role.findById(roleId).session(session);
		if (!role) throw new Error("Role not found");
...
export const assignRoleToUser = async (tenantId, userId, roles, updatedBy) => {
	return runTransaction(async (session) => {
...
export const revokeRoleFromUser = async (tenantId, userId, role, updatedBy) => {
	return runTransaction(async (session) => {
...
export const checkUserPermission = async (userId, tenantId, feature, action) => {
...
export const getUserRoles = async (userId, tenantId) => {
