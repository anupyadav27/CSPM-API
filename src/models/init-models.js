...
import _high_priority_vulnerabilities from "./high_priority_vulnerabilities.js";
...
import _source_health_summary from "./source_health_summary.js";
...
export default function initModels(sequelize) {
    ...
    const high_priority_vulnerabilities = _high_priority_vulnerabilities.init(sequelize, DataTypes);
    ...
    const source_health_summary = _source_health_summary.init(sequelize, DataTypes);
    ...
    assets.belongsToMany(policies, { as: "policy_id_policies", through: policy_assets, foreignKey: "asset_id", otherKey: "policy_id" });
    assets.belongsToMany(reports, { as: "report_id_reports", through: report_assets, foreignKey: "asset_id", otherKey: "report_id" });
    assets.belongsToMany(threats, { as: "threat_id_threats", through: asset_threats, foreignKey: "asset_id", otherKey: "threat_id" });
    compliance.belongsToMany(assets, { as: "asset_id_assets", through: asset_compliance, foreignKey: "compliance_id", otherKey: "asset_id" });
    ...
    ios_advisory.belongsToMany(ios_cve, { as: "cve_id_ios_cves", through: ios_advisory_cve, foreignKey: "advisory_id", otherKey: "cve_id" });
    ...
    ios_cve.belongsToMany(ios_update, { as: "update_id_ios_updates", through: ios_update_cve, foreignKey: "cve_id", otherKey: "update_id" });
    ios_update.belongsToMany(ios_cve, { as: "cve_id_ios_cve_ios_update_cves", through: ios_update_cve, foreignKey: "update_id", otherKey: "cve_id" });
    permissions.belongsToMany(roles, { as: "role_id_roles", through: role_permissions, foreignKey: "permission_key", otherKey: "role_id" });
    policies.belongsToMany(assets, { as: "asset_id_assets_policy_assets", through: policy_assets, foreignKey: "policy_id", otherKey: "asset_id" });
    ...
    reports.belongsToMany(assets, { as: "asset_id_assets_report_assets", through: report_assets, foreignKey: "report_id", otherKey: "asset_id" });
    ...
    tenants.belongsToMany(users, { as: "user_id_users", through: tenant_users, foreignKey: "tenant_id", otherKey: "user_id" });
    threats.belongsToMany(assets, { as: "asset_id_assets_asset_threats", through: asset_threats, foreignKey: "threat_id", otherKey: "asset_id" });
    users.belongsToMany(roles, { as: "role_id_roles_user_roles", through: user_roles, foreignKey: "user_id", otherKey: "role_id" });
    users.belongsToMany(tenants, { as: "tenant_id_tenants", through: tenant_users, foreignKey: "user_id", otherKey: "tenant_id" });
    ...
    scan_vulnerabilities.belongsTo(agents, { as: "agent", foreignKey: "agent_id" });
    agents.hasMany(scan_vulnerabilities, { as: "scan_vulnerabilities", foreignKey: "agent_id" });
    scans.belongsTo(agents, { as: "agent", foreignKey: "agent_id" });
    agents.hasMany(scans, { as: "scans", foreignKey: "agent_id" });
    ...
    asset_compliance.belongsTo(assets, { as: "assets", foreignKey: "asset_id" });
    assets.hasMany(asset_compliance, { as: "asset_compliances", foreignKey: "asset_id" });
    asset_tags.belongsTo(assets, { as: "assets", foreignKey: "asset_id" });
    assets.hasMany(asset_tags, { as: "asset_tags", foreignKey: "asset_id" });
    asset_threats.belongsTo(assets, { as: "assets", foreignKey: "asset_id" });
    assets.hasMany(asset_threats, { as: "asset_threats", foreignKey: "asset_id" });
    policy_assets.belongsTo(assets, { as: "assets", foreignKey: "asset_id" });
    assets.hasMany(policy_assets, { as: "policy_assets", foreignKey: "asset_id" });
    report_assets.belongsTo(assets, { as: "assets", foreignKey: "asset_id" });
    assets.hasMany(report_assets, { as: "report_assets", foreignKey: "asset_id" });
    connector_health_issues.belongsTo(cloud_connectors, { as: "connector", foreignKey: "connector_id" });
    cloud_connectors.hasMany(connector_health_issues, { as: "connector_health_issues", foreignKey: "connector_id" });
    ...
    compliance_remediation_steps.belongsTo(compliance, { as: "compliance", foreignKey: "compliance_id" });
    compliance.hasMany(compliance_remediation_steps, { as: "compliance_remediation_steps", foreignKey: "compliance_id" });
    policy_compliance.belongsTo(compliance, { as: "compliance", foreignKey: "compliance_id" });
    compliance.hasMany(policy_compliance, { as: "policy_compliances", foreignKey: "compliance_id" });
    report_compliance.belongsTo(compliance, { as: "compliance", foreignKey: "compliance_id" });
    compliance.hasMany(report_compliance, { as: "report_compliances", foreignKey: "compliance_id" });
    android_cve.belongsTo(cves, { as: "cve", foreignKey: "cve_id" });
    cves.hasOne(android_cve, { as: "android_cve", foreignKey: "cve_id" });
    ...
    ios_cve.belongsTo(cves, { as: "cve", foreignKey: "cve_id" });
    cves.hasOne(ios_cve, { as: "ios_cve", foreignKey: "cve_id" });
    scan_vulnerabilities.belongsTo(cves, { as: "cve", foreignKey: "cve_id" });
    cves.hasMany(scan_vulnerabilities, { as: "scan_vulnerabilities", foreignKey: "cve_id" });
    windows_cve.belongsTo(cves, { as: "cve", foreignKey: "cve_id" });
    cves.hasOne(windows_cve, { as: "windows_cve", foreignKey: "cve_id" });
    ...
    cve_attack_mappings.belongsTo(mitre_techniques, { as: "technique", foreignKey: "technique_id" });
    mitre_techniques.hasMany(cve_attack_mappings, { as: "cve_attack_mappings", foreignKey: "technique_id" });
    notification_rules.belongsTo(notification_settings, { as: "setting", foreignKey: "settings_id" });
    notification_settings.hasMany(notification_rules, { as: "notification_rules", foreignKey: "settings_id" });
    role_permissions.belongsTo(permissions, { as: "permission_key_permission", foreignKey: "permission_key" });
    permissions.hasMany(role_permissions, { as: "role_permissions", foreignKey: "permission_key" });
    quality_metrics.belongsTo(pipeline_executions, { as: "pipeline_run", foreignKey: "pipeline_run_id" });
    pipeline_executions.hasMany(quality_metrics, { as: "quality_metrics", foreignKey: "pipeline_run_id" });
    source_fetch_audit.belongsTo(pipeline_executions, { as: "pipeline_run", foreignKey: "pipeline_run_id" });
    pipeline_executions.hasMany(source_fetch_audit, { as: "source_fetch_audits", foreignKey: "pipeline_run_id" });
    ...
    tenants.hasMany(compliance, { as: "compliance", foreignKey: "tenant_id" });
    ...
    tenants.hasMany(notification_settings, { as: "notification_settings", foreignKey: "tenant_id" });
    ...
    threats.hasMany(threat_related_findings, { as: "threat_related_findings", foreignKey: "threat_id" });
    threat_remediation_steps.belongsTo(threats, { as: "threat", foreignKey: "threat_id" });
    threats.hasMany(threat_remediation_steps, { as: "threat_remediation_steps", foreignKey: "threat_id" });
    ...
    users.hasMany(cloud_connectors, { as: "updated_by_cloud_connectors", foreignKey: "updated_by" });
    ...
    pipeline_executions.belongsTo(users, { as: "created_by_user", foreignKey: "created_by" });
    users.hasMany(pipeline_executions, { as: "pipeline_executions", foreignKey: "created_by" });
    ...
    vulnerability_sources.hasMany(cve_update_marker, { as: "cve_update_markers", foreignKey: "source_id" });
    ...
    vulnerability_sources.hasMany(quality_metrics, { as: "quality_metrics", foreignKey: "source_id" });
    source_fetch_audit.belongsTo(vulnerability_sources, { as: "source", foreignKey: "source_id" });
    vulnerability_sources.hasMany(source_fetch_audit, { as: "source_fetch_audits", foreignKey: "source_id" });
    windows_advisory_cve.belongsTo(windows_advisory, { as: "advisory", foreignKey: "advisory_id" });
    windows_advisory.hasMany(windows_advisory_cve, { as: "windows_advisory_cves", foreignKey: "advisory_id" });
    windows_advisory_cve.belongsTo(windows_cve, { as: "cve", foreignKey: "cve_id" });
    windows_cve.hasMany(windows_advisory_cve, { as: "windows_advisory_cves", foreignKey: "cve_id" });
    ...
    windows_product.hasMany(windows_cve_product, { as: "windows_cve_products", foreignKey: "product_id" });
